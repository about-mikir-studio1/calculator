...
String angka;
    ...
    private void initComponents() {
        ...
        jRadioButton1.setFont(new java.awt.Font("Impact", 1, 14)); // NOI18N
        jRadioButton1.setSelected(true);
        jRadioButton1.setText("Purnama");
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 180, -1));
